<template>
  <v-card class="mx-auto" color="alter" dark>
    ...
    <v-card-actions class="d-flex">
      <v-row dense>
        <v-col>
          <v-btn small class="yellow darken-3 ma-2">
            <v-icon> mdi-script-text </v-icon>
            Todos
          </v-btn>
          <v-btn small class="red darken-1 ma-2">
            <v-icon> mdi-cancel </v-icon>
            Cancelados
          </v-btn>
          <v-btn small class="green darken-1 ma-2">
            <v-icon> mdi-check-bold </v-icon>
            Entregados
          </v-btn>
          <v-btn small class="blue accent-1 ma-2">
            <v-icon> mdi-truck-fast </v-icon>
            Regresados
          </v-btn>
          <v-btn small class="purple darken-1 ma-2">
